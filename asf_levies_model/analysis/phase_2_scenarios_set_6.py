...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_flourish.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_histogram_tables.xlsx"
try:
