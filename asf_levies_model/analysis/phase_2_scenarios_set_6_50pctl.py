...
# Create 50th Percentile columns to use in consumer collection
...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_50pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_flourish_50pct.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_histogram_tables_50pct.xlsx"
try:
