...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_2.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_2_flourish.xlsx"
)
try:
...
pickle_path_support_info = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_2_support_information.pkl"
