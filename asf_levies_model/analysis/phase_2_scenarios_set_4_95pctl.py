...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_95pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_95pct_flourish.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_95pct_histogram_tables.xlsx"
try:
