...
# We need this set of archetypes to specify unit discounts that are consistent
...
scenario_1_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_2_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_3_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_4_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_5_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_6_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_7_consumers = get_tdcv_consumers(
...
# Create ConsumerCollection
scenario_8_consumers = get_tdcv_consumers(
...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_tdcv.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_flourish_tdcv.xlsx"
)
try:
