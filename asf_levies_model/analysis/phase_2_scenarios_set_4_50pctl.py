...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_50pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_50pct_flourish.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_4_50pct_histogram_tables.xlsx"
try:
