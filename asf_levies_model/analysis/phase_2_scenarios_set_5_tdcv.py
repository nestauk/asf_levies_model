...
Note that in this set, results are calculated for typical domestic consumption values (TDCV) set by ofgem for the energy price cap.
However, the archetypes are retained to compute the various discounts so that the sets are comparable.
...
"""
000. TDCV Consumer Collection
"""


# Create a consumer collection for tdcv consumers
def get_tdcv_consumers(
    collection_name: str, gas_tariff: tariffs.Tariff, electricity_tariff: tariffs.Tariff
) -> ConsumerCollection:
    """Return tdcv consumer collection with provided name and tariffs."""
    tdcv_consumers = []
    for name, gas, electric in (
        ("low_tdcv", 7.5, 1.8),
        ("medium_tdcv", 11.5, 2.7),
        ("high_tdcv", 17, 4.1),
    ):
        for eligibility in [True, False]:
            tdcv_consumers.append(
                Consumer(
                    name=name,
                    archetype=name,
                    net_annual_income=np.nan,
                    net_income_decile=np.nan,
                    main_heating_fuel="Gas",
                    gas_consumption=gas,
                    electricity_consumption=electric,
                    gas_tariff=gas_tariff,
                    electricity_tariff=electricity_tariff,
                    unmetered_fuel_spend=np.nan,
                    scheme_eligible=eligibility,
                )
            )

    return ConsumerCollection(name=collection_name, consumers=tdcv_consumers)


"""
00. Status quo - Archetypes
"""
# Create a status quo WHD rebate ConsumerCollection
# We need this set of archetypes to specify unit discounts that are consistent with the archetypes set 5.
...
# Status quo for TDCV consumers
status_quo_tdcv_consumers = get_tdcv_consumers(
    "Status_quo (TDCV)", gas_tariff=gas_tariff, electricity_tariff=electricity_tariff
)

status_quo_tdcv_consumers_flat_rebate = (
    status_quo_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity", -150, "flat adjustment", inplace=False
    )
)
...
rebalanced_tdcv_consumers = get_tdcv_consumers(
...
rebalanced_tdcv_consumers_flat_rebate = (
    rebalanced_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity", -150, "flat adjustment", inplace=False
    )
)
...
# Add records for tdcvs
cwp_sizes["low_tdcv"] = {True: 4268039, False: 22714592}
cwp_sizes["medium_tdcv"] = {True: 4268039, False: 22714592}
cwp_sizes["high_tdcv"] = {True: 4268039, False: 22714592}
...
# Add records for tdcvs
whd_sizes["low_tdcv"] = {True: 4709573, False: 22273058}
whd_sizes["medium_tdcv"] = {True: 4709573, False: 22273058}
whd_sizes["high_tdcv"] = {True: 4709573, False: 22273058}
...
scenario_1_tdcv_consumers = get_tdcv_consumers(
...
scenario_1_tdcv_consumers_unit_discount = (
    scenario_1_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
        scenario_1_unit_discount_electricity,
        "unit discount",
        inplace=False,
...
# Create ConsumerCollection
scenario_2_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_2_tdcv_consumers_unit_discount = (
    scenario_2_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_3_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_3_tdcv_consumers_unit_discount = (
    scenario_3_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_4_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_4_tdcv_consumers_unit_discount = (
    scenario_4_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_5_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_5_tdcv_consumers_unit_discount = (
    scenario_5_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_6_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_6_tdcv_consumers_unit_discount = (
    scenario_6_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
        scenario_6_unit_discount_electricity,
        "unit discount",
        inplace=False,
...
# Create ConsumerCollection
scenario_7_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_7_tdcv_consumers_unit_discount = (
    scenario_7_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_8_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_8_tdcv_consumers_unit_discount = (
    scenario_8_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_9_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_9_tdcv_consumers_unit_discount = (
    scenario_9_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_10_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_10_tdcv_consumers_unit_discount = (
    scenario_10_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
# Create ConsumerCollection
scenario_11_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_11_tdcv_consumers_unit_discount = (
    scenario_11_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
        scenario_11_unit_discount_electricity,
        "unit discount",
        inplace=False,
...
# Create ConsumerCollection
scenario_12_tdcv_consumers = get_tdcv_consumers(
...
# Unit discount approach: Gas and electricity
# Apply support to eligible consumers
scenario_12_tdcv_consumers_unit_discount = (
    scenario_12_tdcv_consumers.apply_support_to_eligible_consumers(
        "electricity",
...
consumer_collections_levy_scenario = {
    status_quo_tdcv_consumers_flat_rebate: scenario_description.get("status quo"),
    rebalanced_tdcv_consumers_flat_rebate: scenario_description.get("rebalanced"),
    scenario_1_tdcv_consumers_unit_discount: scenario_description.get("scenario_1"),
    scenario_2_tdcv_consumers_unit_discount: scenario_description.get("scenario_2"),
    scenario_3_tdcv_consumers_unit_discount: scenario_description.get("scenario_3"),
    scenario_4_tdcv_consumers_unit_discount: scenario_description.get("scenario_4"),
    scenario_5_tdcv_consumers_unit_discount: scenario_description.get("scenario_5"),
    scenario_6_tdcv_consumers_unit_discount: scenario_description.get("scenario_6"),
    scenario_7_tdcv_consumers_unit_discount: scenario_description.get("scenario_7"),
    scenario_8_tdcv_consumers_unit_discount: scenario_description.get("scenario_8"),
    scenario_9_tdcv_consumers_unit_discount: scenario_description.get("scenario_9"),
    scenario_10_tdcv_consumers_unit_discount: scenario_description.get("scenario_10"),
    scenario_11_tdcv_consumers_unit_discount: scenario_description.get("scenario_11"),
    scenario_12_tdcv_consumers_unit_discount: scenario_description.get("scenario_12"),
}

consumer_collections_support_type = {
    status_quo_tdcv_consumers_flat_rebate: "Flat rebate",
    rebalanced_tdcv_consumers_flat_rebate: "Flat rebate",
    scenario_1_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_2_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_3_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_4_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_5_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_6_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_7_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_8_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_9_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_10_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_11_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
    scenario_12_tdcv_consumers_unit_discount: "Unit discount on gas and electricity",
}

consumer_collections_eligibility = {
    status_quo_tdcv_consumers_flat_rebate: "WHD",
    rebalanced_tdcv_consumers_flat_rebate: "WHD",
    scenario_1_tdcv_consumers_unit_discount: "CWP",
    scenario_2_tdcv_consumers_unit_discount: "CWP",
    scenario_3_tdcv_consumers_unit_discount: "CWP",
    scenario_4_tdcv_consumers_unit_discount: "CWP",
    scenario_5_tdcv_consumers_unit_discount: "CWP",
    scenario_6_tdcv_consumers_unit_discount: "CWP",
    scenario_7_tdcv_consumers_unit_discount: "CWP",
    scenario_8_tdcv_consumers_unit_discount: "CWP",
    scenario_9_tdcv_consumers_unit_discount: "CWP",
    scenario_10_tdcv_consumers_unit_discount: "CWP",
    scenario_11_tdcv_consumers_unit_discount: "CWP",
    scenario_12_tdcv_consumers_unit_discount: "CWP",
}
...
others_weighted_avg = (
    ...
    .reset_index(names="Weighted average")
)
# Merge into summary table
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_tdcv_scenarios_set_5_histogram_tables.xlsx"
try:
