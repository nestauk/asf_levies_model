...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_95pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_flourish_95pct.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_6_histogram_tables_95pct.xlsx"
try:
