...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_5pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_flourish_5pct.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_histogram_tables_5pct.xlsx"
try:
