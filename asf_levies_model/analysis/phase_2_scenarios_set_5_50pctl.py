...
scenario_1_consumers = ConsumerCollection.from_dataframe(
    ...
    net_income_decile_col="NetIncomeDecile",
    main_heating_fuel_col="ArchetypeHeatingFuel",
    gas_consumption_col="GaskWh0PCT",
    electricity_consumption_col="ElectricitySingleRatekWh_50PCT",
...
filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_50pct.xlsx"
...
"""
flourish_filename = (
    f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_flourish_50pct.xlsx"
)
try:
...
histograms_filename = f"{PROJECT_DIR}/outputs/data/{date_str}_phase_2_scenarios_set_5_histogram_tables_50pct.xlsx"
try:
